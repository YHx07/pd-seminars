...
3. Замер времениа работы программы и профилировщике

Выигрыша по времени по сравнению с CPU в задачах в этом занятии не будет. Чтобы выиграть по времени в вычислениях на GPU нужно:
...
5. Эксперимент, демонстрирующий почему программа из пунктов 3-4 работает медленно.
...
Идея: в множестве задач нужно преобразовать один вектор в другой вектор, причем все элементры вектора подвергаются одной операции. Видеокарта позволит произвести эти однотипные вычисления за один такт процессора.
