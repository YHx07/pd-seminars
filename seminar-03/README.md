...
Далее девайсом называется GPU, хостом -- CPU.
...
Имеем два параметра в <<<>>>, которые означают количество потоков, на которое мы распределяем задачу. Давайте пробовать ускорять её:
