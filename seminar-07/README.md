...
- Attempt -- таска состоит из нескольких attempt-ов. Если первый attempt падает с ошибкой, то запускается второй. Максимальное количество attempt-ов настраивается, но обычно их 3. Если 3 attempt-а упали, то таска становится Failed.
