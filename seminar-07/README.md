...
На практике писать чистые MapReduce задачи скорее всего не понадобится. Аналитики, разработтчики почти всегда работают с верхнеуровневыми инструментами, которые реалзиуют обработку данных с помощью SQL, Java, Python, C++ и прочих языков программирования.
